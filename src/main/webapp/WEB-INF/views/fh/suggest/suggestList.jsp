...
$(function () {
   ...
   $("#btn_add").click(function(){
    ...
    $("#btn_delete").click(function(){
    	var selects = $("#tb_departments").bootstrapTable('getSelections');
	    if(selects.length==1){
	        var id = selects[0].suggestId;
	        var dialog = $.fn.modalConfirm('您确定要删除？', function(pass){
	        	if(pass){
	        		$.postJSON('${adminPath}/suggest/delete?suggestId='+id, function(data){
	        			if(data.errno==0){
		        			//refreshTable();
		        			oTable.refresh();
	        			}else{
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: '${adminPath}/suggest/dataList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            ...
            uniqueId: "suggestId",                     //每一行的唯一标识，一般为主键列
