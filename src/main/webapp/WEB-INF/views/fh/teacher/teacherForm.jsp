		...
		<div class="box box-info">
			...
			<form class="form-horizontal" id="form">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="teacherName" class="col-xs-2 col-sm-2 control-label">教师名称</label>
						<div class="col-xs-10 col-sm-10">
							<input name="teacherName" value="${teacher.teacherName }" type="text" class="form-control" id="teacherName" placeholder="教师名称"
								   isvalid="yes" checkexpession="NotNull" errormsg="教师名称">
						</div>
					</div>
					<div class="form-group" style="width:180px;height: 180px">
						...
						<div class="col-sm-10">
							...
							<input  type="hidden" name="bannerImg" value="${teacher.logo }" >
							<div class="img-container"><c:if test="${teacher.logo != null && teacher.logo != ''}"><img src="${ctxPath}${teacher.logo }" style="width:150px;height: 150px"></c:if></div>
						</div>
					</div>
					<div class="form-group">
						<label for="textArea1" class="col-sm-2 control-label">教师介绍</label>
						<div class="col-sm-10">
							<textarea class="ckeditor" name="introduction" id="textArea1" cols="20" rows="5">${teacher.introduction }</textarea>
						</div>
					</div>
...
<script type="text/javascript">
    ...
    function submitForm(dialog, oTable){
        ...
        if($("#form").Validform()){
            ...
            $.ajax({
                url:"${adminPath}/teacher/formCheck",
                type:"post",
                dataType : "json",
                data:form,
                processData:false,
