    ...
    <div class="panel panel-default" style="margin:0px;padding:0px">
        <form id="formSearch" class="form-horizontal" style="margin:0px;padding:0px">
            <div class="form-group" style="margin-top:15px">
                <label class="control-label col-sm-1" for="teacherName">教师名称</label>
                <div class="col-sm-2">
...
$(function () {
   ...
   $("#btn_add").click(function(){
    ...
    $("#btn_edit").click(function(){
	    ...
	    if(selects.length==1){
	        var id = selects[0].teacherId;
            var schoolId = selects[0].schoolId;
			var dialog = $.fn.modalOpen({
			    id: "Form",
			    title: '编辑',
			    url: '${adminPath}/teacher/form?teacherId='+id+"&schoolId="+schoolId,
			    width: "750px",
			    height: "750px",
			    callBack: function (iframeId) {
                    top.frames[iframeId].submitForm(dialog, oTable);
    ...
    $("#btn_delete").click(function(){
	    ...
	    if(selects.length==1){
	        var id = selects[0].teacherId;
	        var dialog = $.fn.modalConfirm('您确定要删除分此教师？', function(pass){
	        	if(pass){
	        		$.postJSON('${adminPath}/teacher/delete?teacherId='+id, function(data){
	        			if(data.errno==0){
		        			//refreshTable();
		        			oTable.refresh();
	        			}else{
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: '${adminPath}/teacher/teacherDataList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
