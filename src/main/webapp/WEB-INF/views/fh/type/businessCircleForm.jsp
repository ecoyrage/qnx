...
<div class="col-md-6">
	<div class="box box-info">
		...
		<form class="form-horizontal" id="form">
		    <div class="box-body">
		    	<input type="hidden" id="id" name="id" value="${businessCircle.id }"/>
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-xs-10 col-sm-10">
		            	<input type="hidden" name="parentId" id="parentId" value="${businessCircle.parentId }" >
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-xs-10 col-sm-10">
		                <input name="name" id="name" value="${businessCircle.name }" type="text" class="form-control" placeholder="类目名称"
...
function submitForm(dialog, oTable){
	if($("#form").Validform()){
		$.postJSON("${adminPath}/type/businessCircleCheck", $("#form").serializeObject(), function(data){
