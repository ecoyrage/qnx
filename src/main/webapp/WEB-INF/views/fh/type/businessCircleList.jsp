...
$(function () {
    ...
    $("#btn_add").click(function(){
        ...
        var dialog = $.fn.modalOpen({
            id: "Form",
            title: '新增',
            url: '${adminPath}/type/businessCircleForm',
            width: "550px",
            height: "450px",
    ...
    $("#btn_delete").click(function(){
	    ...
	    if(selects.length==1){
	        ...
	        var dialog = $.fn.modalConfirm('您确定要删除类目：'+selects[0].name+'？', function(pass){
	        	if(pass){
	        		$.postJSON('${adminPath}/type/delete?businessCircleId='+id, function(data){
                        if (0 == data.code) {
...
function addChild(id){
	...
	if(id!=undefined){
		var dialog = $.fn.modalOpen({
		    id: "Form",
		    title: '编辑',
		    url: '${adminPath}/type/businessCircleForm?parentId='+id,
            width: "550px",
            height: "450px",
		    callBack: function (iframeId) {
                top.frames[iframeId].submitForm(dialog, oTable);
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: '${adminPath}/type/businessCircleDataList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
