...
<section class="content">
    ...
    <div class="panel panel-default" style="margin:0px;padding:0px">
        <form id="formSearch" class="form-horizontal" style="margin:0px;padding:0px">
            <div class="form-group" style="margin-top:15px">
                ...
                <%--<label class="control-label col-sm-1" for="productName">名称</label>
                <div class="col-sm-2">
    ...
    <div id="toolbar" class="btn-group">
        <button id="btn_add" type="button" class="btn btn-default">
            <span class="glyphicon" aria-hidden="true"></span>新增学校
        </button>
        ...
        <button id="btn_addCourse" type="button" class="btn btn-default">
            <span class="glyphicon" aria-hidden="true"></span>新增课程
        </button>
        <button id="btn_addTeacher" type="button" class="btn btn-default">
            <span class="glyphicon" aria-hidden="true"></span>新增教师
        </button>
    </div>
...
<script>
    ...
    $(function () {
        ...
        $("#btn_addCourse").click(function(){
            ...
            if(selects.length==1){
                var id = selects[0].schoolId;
                var dialog = $.fn.modalOpen({
                    id: "Form",
                    title: '新增课程',
                    url: '${adminPath}/course/form?schoolId='+id,
                    width: "750px",
                    height: "750px",
                    callBack: function (iframeId) {
                        top.frames[iframeId].submitForm(dialog, oTable);
        ...
        $("#btn_addTeacher").click(function(){
            ...
            if(selects.length==1){
                ...
                var dialog = $.fn.modalOpen({
                    id: "Form",
                    title: '新增教师',
                    url: '${adminPath}/teacher/form?schoolId='+id,
                    width: "750px",
                    height: "750px",
                    callBack: function (iframeId) {
                        top.frames[iframeId].submitForm(dialog, oTable);
        ...
        $("#btn_edit").click(function(){
            ...
            if(selects.length==1){
                ...
                var dialog = $.fn.modalOpen({
                    id: "Form",
                    title: '编辑',
                    url: '${adminPath}/school/form?schoolId='+id,
                    width: "750px",
                    height: "750px",
                    callBack: function (iframeId) {
                        top.frames[iframeId].submitForm(dialog, oTable);
        ...
        $("#btn_delete").click(function(){
            ...
            if(selects.length==1){
                var id = selects[0].schoolId;
                var dialog = $.fn.modalConfirm('您确定要删除该课程？', function(pass){
                    if(pass){
                        $.postJSON('${adminPath}/school/delete?schoolId='+id, function(data){
                            if(data.errno==0){
                                //refreshTable();
                                oTable.refresh();
                            }else{
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tb_departments').bootstrapTable({
                url: '${adminPath}/school/dataList',         //请求后台的URL（*）
                method: 'post',                      //请求方式（*）
