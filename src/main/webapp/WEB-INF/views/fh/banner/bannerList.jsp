    ...
    <%--<div class="panel panel-default" style="margin:0px;padding:0px">
        <form id="formSearch" class="form-horizontal" style="margin:0px;padding:0px">
            <div class="form-group" style="margin-top:15px">
                <label class="control-label col-sm-1" for="productNo">编号</label>
                <div class="col-sm-2">
                ...
                &lt;%&ndash;<div class="col-sm-2" style="text-align:left;">
                    <button   style="margin-left:50px" id="btn_query" class="btn btn-sm btn-primary" ><span class="glyphicon glyphicon-search"></span> 查询</button>
                </div>&ndash;%&gt;
            </div>
        </form>
    </div>--%>
    ...
    $("#btn_edit").click(function(){
	    ...
	    if(selects.length==1){
			...
			var dialog = $.fn.modalOpen({
			    id: "Form",
			    title: '编辑',
			    url: '${adminPath}/banner/form?bannerId='+id,
			    width: "750px",
			    height: "750px",
			    callBack: function (iframeId) {
                    top.frames[iframeId].submitForm(dialog, oTable);
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: '${adminPath}/banner/dataList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            ...
            columns: [{
                ...
                formatter:function(value,row,index){
                    if(value==1) value = '头部图';
                    else if(value==2) value = '中部上图';
                    else if(value==3) value = '中部下图';
                    return value;
                }
            },{
                field: 'createTime',
