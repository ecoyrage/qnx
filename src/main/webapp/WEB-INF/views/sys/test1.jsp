...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/daterangepicker/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="${ctxPath}/static/content/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<script src="${ctxPath}/static/content/min/js/supershopui.common.js"></script>
    ...
    <script src="${ctxPath}/static/content/plugins/jQueryUI/jquery-ui.min.js"></script>
    <script src="${ctxPath}/static/content/plugins/raphael/raphael.min.js"></script>
    <script src="${ctxPath}/static/content/plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
    <script src="${ctxPath}/static/content/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    <script src="${ctxPath}/static/content/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctxPath}/static/content/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="${ctxPath}/static/content/plugins/knob/jquery.knob.js"></script>
    <!-- daterangepicker -->
    <script src="${ctxPath}/static/content/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- datepicker -->
    <script src="${ctxPath}/static/content/plugins/datepicker/bootstrap-datepicker.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script src="${ctxPath}/static/content/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="${ctxPath}/static/content/adminlte/dist/js/pages/dashboard.js"></script>
    <script>
